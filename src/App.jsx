...
function App() {
  const name = "Mohammad Faheem";
  const profession = "Frontend Developer";
  const experience = 1;
  const skills = ["HTML", "CSS", "JavaScript", "React"];
  let profile = [
    { Name: "Faheem", Profission: "Developer", Qulification: "AD" },
    { Name: "Khattak", Profission: "Graphic designer", Qulification: "BS" },
    { Name: "Orakzaii", Profission: "Socail Madia manager", Qulification: "FSC" },
  ];
